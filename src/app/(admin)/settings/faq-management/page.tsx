...
export default function FaqManagementPage() {
  ...
  const inputClasses =
    "block w-full px-3 py-2 bg-[#0E1628] border border-[#1E2D45] rounded-md text-white text-sm placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-[#62A0EA] transition-colors";
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <h3 className="text-sm sm:text-base text-white font-semibold break-words">
                          {faq.question}
                        </h3>
                      </div>
                      <p className="text-xs sm:text-sm text-slate-400 ml-6 break-words">
                        {faq.answer}
                      </p>
                    </div>
