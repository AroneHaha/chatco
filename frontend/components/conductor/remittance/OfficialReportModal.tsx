  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td style="color:#2563eb">${fmt(report.cashlessBreakdown.scanned)}</td>
      </tr>
      <tr>
        <td><span class="dot dot-green"></span>Prepaid</td>
        <td style="color:#16a34a">${fmt(report.cashlessBreakdown.prepaid)}</td>
      </tr>
      <tr>
    ...
    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center">
      ...
      <div className="relative w-full max-w-md bg-[#0F2135] border border-white/[0.08] rounded-t-3xl sm:rounded-3xl overflow-hidden shadow-2xl animate-slide-up max-h-[90vh] flex flex-col mb-16 sm:mb-0">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-5">
          ...
          <div className="space-y-2"><p className="text-[10px] font-bold text-white/40 uppercase tracking-wider">Cashless Collection</p><div className="bg-white/[0.03] border border-white/[0.05] rounded-xl overflow-hidden"><table className="w-full"><thead><tr className="border-b border-white/[0.06]"><th className="text-left text-[9px] font-bold text-white/30 uppercase tracking-wider px-3.5 py-2.5">Method</th><th className="text-right text-[9px] font-bold text-white/30 uppercase tracking-wider px-3.5 py-2.5">Amount</th></tr></thead><tbody className="divide-y divide-white/[0.03]"><tr><td className="px-3.5 py-2.5 flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-[#62A0EA]" /><span className="text-xs text-white/60">QR Scanned</span></td><td className="px-3.5 py-2.5 text-right text-xs font-bold text-[#62A0EA] tabular-nums">{fmt(activeReport.cashlessBreakdown.scanned)}</td></tr><tr><td className="px-3.5 py-2.5 flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-emerald-400" /><span className="text-xs text-white/60">Prepaid</span></td><td className="px-3.5 py-2.5 text-right text-xs font-bold text-emerald-400 tabular-nums">{fmt(activeReport.cashlessBreakdown.prepaid)}</td></tr><tr><td className="px-3.5 py-2.5 flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-amber-400" /><span className="text-xs text-white/60">Voucher</span></td><td className="px-3.5 py-2.5 text-right text-xs font-bold text-amber-400 tabular-nums">{fmt(activeReport.cashlessBreakdown.voucher)}</td></tr></tbody><tfoot><tr className="bg-white/[0.03]"><td className="px-3.5 py-2.5 text-[10px] font-bold text-white/50 uppercase tracking-wider">Subtotal</td><td className="px-3.5 py-2.5 text-right text-sm font-extrabold text-white tabular-nums">{fmt(activeReport.totalCashless)}</td></tr></tfoot></table></div></div>
