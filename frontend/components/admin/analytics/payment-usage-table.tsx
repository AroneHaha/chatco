...
const PAYMENT_USAGE_DATA = [
  { method: "Self-Pay (Online/App)", transactions: 4200, percentage: 65, amount: "₱84,000", color: "bg-[#1A5FB4]" },
  { method: "Conductor Scan (Commuter QR)", transactions: 1575, percentage: 24, amount: "₱31,500", color: "bg-[#62A0EA]" },
  { method: "Offline Wallet (Conductor Device)", transactions: 715, percentage: 11, amount: "₱14,300",color: "bg-purple-500" },
];

export function PaymentUsageTable() {
  return (
    <div className="bg-white/[0.04] border border-white/10 rounded-xl p-5">
      <h3 className="text-sm font-semibold text-white mb-4">Payment Method Usage</h3>
      
      {/* Table Header */}
      <div className="grid grid-cols-12 gap-2 px-3 py-2 text-[10px] uppercase tracking-wider text-white/30 font-semibold border-b border-white/[0.06]">
