...
export default function LoginForm() {
  ...
  return (
    <div>
      <h2 className="text-3xl font-bold text-[#071A2E] tracking-tight">
        Welcome back
      </h2>
      ...
      {error && (
        <div role="alert" className={`mt-6 border text-sm px-4 py-3 rounded-xl ${
          isSuspendedError
      ...
      <form onSubmit={handleSubmit} className="mt-10 space-y-7">
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            ...
            <Link href="/forgot-password" className="text-sm font-semibold text-[#1A5FB4] hover:text-[#164A8F]">
              Forgot password?
            </Link>
          </div>
          <div className="relative">
            ...
            <button
              ...
              className="absolute inset-y-0 right-0 flex items-center pr-5 text-gray-400 hover:text-gray-600 focus-visible:outline-none focus-visible:text-[#1A5FB4]"
            >
              {showPassword ? (
